...
RecHitCheck::RecHitCheck(TTree *tree, std::string iTempFileName,std::string oTempFileName) : fChain(0) 
{
...
Int_t RecHitCheck::GetEntry(Long64_t entry)
{
...
Long64_t RecHitCheck::LoadTree(Long64_t entry)
{
...
void RecHitCheck::Init(TTree *tree)
{
...
void RecHitCheck::Show(Long64_t entry)
{
...
Int_t RecHitCheck::Cut(Long64_t entry)
{

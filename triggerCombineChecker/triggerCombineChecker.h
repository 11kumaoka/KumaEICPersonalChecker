...
public :
   ...
   TH1D* m_hTriggerTypesBKGCounts; // histogram for trigger types
   TH1D* m_hTriggerTypesBKGRatio; // histogram for trigger types
   
   
   TH1D* m_hEventNumberForEachDetector_WOTrig23_Phys; // event number
   TH1D* m_hEventNumberRatioForEachDetector_WOTrig23_Phys; // event number
   TH1D* m_hEventNumberForEachDetector_WTrig23_Phys; // event number
   TH1D* m_hEventNumberRatioForEachDetector_WTrig23_Phys; // event number
   TH1D* m_hEventNumberForEachDetector_WOTrig23_BKG; // event number
   TH1D* m_hEventNumberRatioForEachDetector_WOTrig23_BKG; // event number
   TH1D* m_hEventNumberForEachDetector_WTrig23_BKG; // event number
   TH1D* m_hEventNumberRatioForEachDetector_WTrig23_BKG; // event number

...
std::vector<SimTrackerHitKuma> eicreconOutputCheck::LoadInputTrkHits() {

    std::vector<SimTrackerHitKuma> hits;

    std::cout << "Loading Tracker input hits..." << std::endl;
    std::cout << "Loading TOFBarrelRecHits hit " << TOFBarrelRecHits_ << std::endl;
